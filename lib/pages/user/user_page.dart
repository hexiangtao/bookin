...
import 'package:bookin/pages/user/wallet_page.dart';
import 'package:bookin/pages/user/coupon_list_page.dart';
import 'package:bookin/pages/user/address_list_page.dart';
import 'package:bookin/pages/user/favorite_list_page.dart';
import 'package:bookin/pages/user/record_list_page.dart';
import 'package:bookin/pages/user/profile_edit_page.dart';
import 'package:bookin/pages/coupon/coupon_center_page.dart';
import 'package:bookin/pages/user/about_page.dart';
import 'package:bookin/pages/user/membership_page.dart';
import 'package:bookin/pages/user/feedback_page.dart';
import 'package:bookin/pages/user/invite_page.dart';
import 'package:bookin/pages/auth/login_page.dart'; // Import login page for navigation after logout
import 'package:bookin/pages/order/order_list_page.dart';
